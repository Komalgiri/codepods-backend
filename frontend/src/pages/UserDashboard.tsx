                        ...
                        <div className="bg-background-surface border border-background-border rounded-2xl p-6 shadow-card">
                            <div className="flex items-center justify-between mb-4">
                                ...
                                <button
                                    ...
                                    className="p-1 hover:bg-background/50 rounded-lg text-primary transition-colors flex items-center justify-center"
                                ...
                                {pods.map((pod) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center -space-x-2">
                                            ...
                                            <div className="w-6 h-6 rounded-full bg-gray-300 border-2 border-background-surface"></div>
                                            <div className="w-6 h-6 rounded-full bg-gray-400 border-2 border-background-surface flex items-center justify-center text-[10px] text-white font-bold">+2</div>
                                        </div>
                                    </div>
                                ))}
                            </div>
